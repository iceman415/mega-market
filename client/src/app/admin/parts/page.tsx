      ...
      <header className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex flex-wrap items-center justify-between gap-y-2">
          <div className="flex items-center gap-3">
            ...
            <h1 className="font-oswald text-xl text-gray-900">Parts</h1>
          </div>
              ...
              >
                <Dialog>
                  <DialogTrigger nativeButton={false} render={<span />}>
                    <button
                      type="button"
                      onClick={() => setPreviewUrl(part.images[0] || null)}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-inter text-sm text-gray-500">
                    #{part.partNumber} &middot; {part.compatibility}
                    {part.sold && (
      ...
      <AlertDialog open={!!deleteId} onOpenChange={(o) => !o && setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This action cannot be undone. The part and its images will be permanently removed.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
