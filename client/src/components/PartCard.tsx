...
export default function PartCard({ part, onClick }: PartCardProps) {
  ...
  const totalImages = part.images.length;
  ...
  return (
    ...
    >
      ...
      >
        <div className="aspect-square">
          <AnimatePresence initial={false} custom={dir}>
            ...
            >
              <Image
                src={part.images[imageIndex] || "/placeholder.svg"}
                alt={part.name}
                fill
                className={cn(
                  "object-cover",
      ...
      <div className="p-4 font-inter">
        ...
        <p className="mb-1 text-xs text-gray-500">PN: {part.partNumber}</p>
        <p className="mb-1 text-xs text-gray-500">Fits: {part.compatibility}</p>
