    ...
    >
      ...
      >
        <div className="aspect-square">
          <AnimatePresence initial={false} custom={dir}>
            ...
            >
              <Image
                src={vehicle.images[imageIndex] || "/placeholder.svg"}
      ...
      <div className="p-4 font-inter">
        <div className="mb-1 flex items-center gap-2">
          <span className="text-sm font-semibold text-gray-900 font-oswald">
        ...
        <div className="flex items-center justify-between">
          ...
          <span className="text-xs text-gray-400">{vehicle.mileage} mi</span>
        </div>
      </div>
    </motion.div>
  );
