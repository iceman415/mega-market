...
import { ArrowLeft, MapPin, ChevronLeft, ChevronRight, MessageCircle } from "lucide-react";
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h1 className="font-oswald text-2xl mb-4">Vehicle not found</h1>
          ...
          >
            ...
            <div className="bg-white rounded-xl p-4 sm:p-6 mb-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="font-inter text-sm text-gray-500">Mileage</p>
                  <p className="font-oswald text-lg">{vehicle.mileage} miles</p>
                </div>
                <div>
                  <p className="font-inter text-sm text-gray-500">Location</p>
                  <p className="font-oswald text-lg flex items-center gap-1">
                    <MapPin className="w-4 h-4" />
                    {vehicle.location || "Dealership"}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl p-4 sm:p-6">
              ...
              <p className="font-inter text-gray-600">{vehicle.description}</p>
            </div>

            <Link href="/contact?item=vehicle">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
